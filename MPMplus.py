    ...
    def __init__(self, args):
        ...
        if self.units[1]:
            self.branch1 = nn.Sequential(
                ...
                BasicConv2d(int(args.hidCNN/2), int(args.hidCNN/2), kernel_size=(1, 3), stride=1, padding=(0, 1)),
                BasicConv2d(int(args.hidCNN/2), args.hidCNN, kernel_size=(3, 1), stride=1, padding=(1,0))
            )
        ...
        if self.units[2]:
            self.branch2 = nn.Sequential(
                ...
                BasicConv2d(int(args.hidCNN/2), int(args.hidCNN/2), kernel_size=(1, 3), stride=1, padding=(0, 1)),
                BasicConv2d(int(args.hidCNN/2), args.hidCNN, kernel_size=(3, 1), stride=1, padding=(1, 0)),
                BasicConv2d(args.hidCNN, args.hidCNN, kernel_size=(1, 3), stride=1, padding=(0, 1)),
                BasicConv2d(args.hidCNN, args.hidCNN, kernel_size=(3, 1), stride=1, padding=(1, 0))
            )
...
class Model(nn.Module):
    def __init__(self, args):
        ...
        self.kernel_l = 3
        self.lcn = SMB(args, self.kernel_l)
